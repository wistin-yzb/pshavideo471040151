...
$field = "id,vid,timeline_num,friend_num,(timeline_num+friend_num) as total_num,share_type,share_time";
//整体
$option  = array('vid'=>"'".$vid."'");
...
//朋友圈
$option = array('vid'=>"'".$vid."'",'share_type'=>'\'timeline\'');
...
//微信朋友
$option = array('vid'=>"'".$vid."'",'share_type'=>'\'friend\'');
...
var chart3 = new iChart.LineBasic2D({
	...
	<?php if($auto == 1):?>
	setTimeout("document.location.href = './sts_chart.php?vid=<?php echo $vid;?>&auto=1'",10 * 1000);
	<?php elseif($auto == 3):?>

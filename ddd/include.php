...
$index_domain = 'qlyx8.com'; //落地域名,【pindazi.com】备用
...
$videolist = json_decode($video_string,true);
$onevideo = $videolist[rand(0,count($videolist)-1)];
$video_id = $onevideo['vid'];

/////////////////////////////////////////////////////
//临时跳转分享文章链接程序处理
$article_list = array(
		'0',
		'http://dsxw.baike.com/ad/gg/', 
);
/////////////////////////////////////////////////////
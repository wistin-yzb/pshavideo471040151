...
function arrSort($a){
	...
	foreach($a as $v) {
		if(isset($b[$v['vid']])){ 
			$b[$v['vid']]['timeline_num'] += $v['timeline_num'];
			$b[$v['vid']]['friend_num'] += $v['friend_num'];
		}else{ 
			$b[$v['vid']] = $v;
		}
	}
...
$field = "id,vid,timeline_num,friend_num,share_type";
...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <td>视频<?php echo $value['vid'];?></td>
                <td>朋友圈：<?php echo $value['timeline_num'];?></td>
                <td>微信群：<?php echo $value['friend_num'];?></td>
                <td><a href="./sts_chart.php?vid=<?php echo $value['vid'];?>">查看</a>
                <a href="./sts_chart.php?vid=<?php echo $value['vid'];?>&auto=1">自动</a>
                </td>
            </tr>                     
            <?php endforeach;?>
            <?php endif;?>

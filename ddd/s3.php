...
{
	$appid = 'wx17298db26b1682f5';
	$appsecret = 'aae76d940d0c46298261d7cef92a2a34';
	$timestamp = time();
...
//http://dsxw.baike.com/ad/ddd/vjk.php?vid=u0730e4dcbi
$dirarr = array('111','222','333','444','555');
$randdir  = $dirarr[rand(0,count($dirarr) - 1)];
if($n==1&&$s=='timeline'||$s=='friend'){ //第一次分享到朋友圈|微信朋友,视频url
	$share_url = 'http://'.$final_domain[0]. '/ad/ddd/'.$randdir.'/vjk.php?vid='.$vid.'#'.time(); //分享的视频链接url
	...
	$share_url = 'http://'.$final_domain[0]. '/ad/ddd/'.$randdir.'/vjk.php?vid='.$vid.'&aid='.$aid.'#'.time(); 
	$share_cover_img = 'http://' . get_rand_str(2,6) . '.' . $index_domain. '/img/cover/11.jpg';
}
///////////////////////////////////////////////////////////////////////////////////////////////////
//分享的文章链接url 临时分享文章链接程序处理
// $aid = rand(1,count($article_list)-1);
// $share_url = 'http://'.$final_domain[0]. '/ad/ddd/vjk.php?vid='.$vid.'&aid='.$aid.'#'.time(); 
///////////////////////////////////////////////////////////////////////////////////////////////////
//获取分享封面图url
//$share_cover_img = 'http://' . get_rand_str(2,6) . '.' . $index_domain. '/img/cover/'.rand(1,10).'.jpg';
//$share_cover_img = 'http://' . get_rand_str(2,6) . '.' . $index_domain. '/img/cover/11.jpg';

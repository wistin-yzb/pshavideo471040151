...
if($checkInfo){ 	
	updatedata($db,$tbName,$vid,$share_type,$option);
}else{ 
	insertdata($db,$tbName,$vid,$share_type,$share_time);
}

//新增用户分享信息
function insertdata($db,$tbName,$vid,$share_type,$share_time){
...
//更新用户分享信息
function updatedata($db,$tbName,$vid,$share_type,$option){		
		switch ($share_type){
			case 'timeline': //朋友圈

...
if($domain == $final_domain[0]){  //非落地域名则跳转落地域名
	...
	header("location:$url");exit;
}elseif(!$_REQUEST['vid']&&$source=='index'){
	$version = get_rand_str(1,6) . rand(1,9) . (time() * 3);
	$url = 'http://' . $domain_arr[0]. '.' . $index_domain. '/' .$version.'?vid='.$video_id.'&source=index';
	file_put_contents('/var/www/project1/domain_index.txt', $video_id);
	header("location:$url");exit;
}
...
<script src="./js/j.js?v=1.1"></script>
...
<body style="background-color: black;">
	<div class="js_video_box" style="">
		...
		<div id="content">
			...
			<div id="tp5" class="js_play_box">
				<div id="mod_tenvideo_video_player_0" class="tenvideo_player" style="width: 100%; height: 200px;">
					<div class="tvp_container tvp_controls_hide">
						...
						<div class="tvp_video">
							<video id="tenvideo_video_player_0" width="100%" height="100%" style="position: absolute; top: -200%;" x-webkit-airplay="true"
								webkit-playsinline="" playsinline="true" preload="none"
								poster="http://i.gtimg.cn/qqlive/images/20150608/black.png"
								src="http://ugcws.video.gtimg.com/uwMRJfz-r5jAYaQXGdGnC2_ppdhgmrDlPaRvaV7F2Ic/u0730e4dcbi.mp4?vkey=46F882ED68DA5C58A7F1EC34F76059954163BD4DD3F0350387FC2580B6E58D2B7DD4CA5438E63AF354EEEBF00D34E416059CCE8080B75CA4CF0536C7DC678A74F4D549199C5A34139FEDD72FD396A6B25389C5866D5A879F57311A581CD593549002CEE219E44A5F9734E30B7D51CCD25FDCAA6C47A3CA52&amp;br=103&amp;platform=2&amp;fmt=auto&amp;level=0&amp;sdtfrom=v5010&amp;guid=289fd2244c4900311c452438ddbc4c79">
							 </video>
			...
			<div class="js_banner_box js_hide" style="width: 100%; bottom: 0; position: fixed;">
	...
	<div class="js_share_box" style="display: none;">
		<div id="tk" style="width: 100%; height: 800px; background: #1c1c1c; position: fixed; left: 0; top: 0;">
			<img class="js_share_pyq_image" style="display: block; width: 100%" src="./img/share_pyq.png">
			<img class="js_share_group_image" style="display: none; width: 100%" src="./img/share_group.png">
		</div>
	</div>
   <script>
   function getSpm() {
	...
	<script src="./js/wsre.js?v=8.9" async="async"></script>
</body>
</html>